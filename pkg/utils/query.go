...
import (
	...
	"database/sql"
	"fmt"
	_type "github.com/RandySteven/Library-GO/pkg/type"
	"log"
	"reflect"
	"strings"
)
...
func QueryValidation(query _type.GoQuery, command string) error {
...
func Save[T any](ctx context.Context, db *sql.DB, query _type.GoQuery, requests ...any) (*uint64, error) {
...
func FindAll[T any](ctx context.Context, db *sql.DB, query _type.GoQuery) (result []*T, err error) {
	requests := new(T)
...
func Delete[T any](ctx context.Context, db *sql.DB, query _type.GoQuery, id uint64) (err error) {
...
func FindByID[T any](ctx context.Context, db *sql.DB, query _type.GoQuery, id uint64, result *T) error {
...
func Update[T any](ctx context.Context, db *sql.DB, query _type.GoQuery, requests ...any) (err error) {
