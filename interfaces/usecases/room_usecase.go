...
type RoomUsecase interface {
	...
	UploadRoomPhoto(ctx context.Context, request *requests.UploadRoomPhoto, fileHeader *multipart.FileHeader) (result *responses.UploadRoomPhotoResponse, customErr *apperror.CustomError)
}
